...
.cat.s-all{--c1:#5291DE;--c2:#005DCF;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='2.10 2.10 19.80 19.80'><g fill='%23000'><rect x='3' y='3' width='8' height='8' rx='2'/><rect x='13' y='3' width='8' height='8' rx='2'/><rect x='3' y='13' width='8' height='8' rx='2'/><rect x='13' y='13' width='8' height='8' rx='2'/></g></svg>")}
.cat.s-trade{--c1:#FEA152;--c2:#FE7501;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0.41 0.96 21.67 21.67'><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M2.5 4h2.3l2.4 10.2h10.4L20 7.5H6'/><g fill='%23000'><circle cx='9' cy='19' r='1.7'/><circle cx='17' cy='19' r='1.7'/></g></svg>")}
.cat.s-wholesale{--c1:#9166F8;--c2:#5D1EF5;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0.34 0.34 23.32 23.32'><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M12 2.5 3.5 7v10l8.5 4.5 8.5-4.5V7z M3.5 7l8.5 4.5L20.5 7 M12 11.5v10'/></svg>")}
.cat.s-property{--c1:#53C4BD;--c2:#02A89E;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0.89 0.89 22.22 22.22'><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M3 11.5 12 4l9 7.5 M5.5 10v10h4.5v-5.5h4V20h4.5V10'/></svg>")}
...
.cat.s-rental{--c1:#63BC93;--c2:#1A9C60;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0.91 0.41 21.67 21.67'><circle stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' cx='7.5' cy='15.5' r='4.5'/><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M10.8 12.2 20.5 2.5 M16.5 6.5l2.8 2.8 M14 9l2 2'/></svg>")}
...
.cat.s-cargo{--c1:#8378F9;--c2:#4938F6;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-0.87 -0.62 25.63 25.63'><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M1.5 5h13.5v11H1.5z M15 9h4.5l3 3.5V16H15'/><g fill='%23000'><circle cx='5' cy='18.5' r='2'/><circle cx='11' cy='18.5' r='2'/><circle cx='19' cy='18.5' r='2'/></g></svg>")}
.cat.s-jobseek{--c1:#65B86B;--c2:#1C9725;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='1.94 1.94 21.12 21.12'><circle stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' cx='10.5' cy='10.5' r='6.5'/><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M15.5 15.5 21 21'/></svg>")}
...
.cat.s-malls{--c1:#F367A4;--c2:#EE1F79;--ic:url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='1.16 1.41 21.67 21.67'><path stroke='%23000' stroke-width='2.2' stroke-linecap='round' stroke-linejoin='round' fill='none' d='M5 8h14l-1 13H6z M9 8V6.5a3 3 0 0 1 6 0V8'/></svg>")}
