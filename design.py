...
.s{display:flex;align-items:center;gap:9px;background:#fff;border-radius:26px;
 padding:0 5px 0 15px;height:48px;box-shadow:0 3px 14px rgba(12,30,60,0.10)}
...
.cat{flex:none;width:94px;border-radius:15px;overflow:hidden;background:var(--card);
 ...
 box-shadow:0 2px 5px rgba(18,32,58,.05),0 10px 20px -12px rgba(18,32,58,0.12)}
...
.cat.pic .pill{display:flex;align-items:center;justify-content:center;
 ...
 box-shadow:0 3px 8px -6px rgba(18,32,58,0.33)}
...
.secn{position:absolute;top:5px;left:5px;z-index:2;min-width:19px;height:19px;
 ...
 font-variant-numeric:tabular-nums;box-shadow:0 2px 6px -2px rgba(14,34,64,0.36)}
...
.cat.on{border-color:var(--gold);
 box-shadow:0 0 0 2px var(--gold),0 10px 22px -12px rgba(14,34,64,0.26)}
...
.rg{flex:none;background:var(--card);border:1px solid var(--mist);border-radius:20px;
 padding:11px 20px;font-size:15px;font-weight:600;color:var(--ink);white-space:nowrap}.cb .rg{border:1.5px solid #9AA8BF}/*PINB2*/.cb .rg{font-size:11.5px;line-height:1.3;padding:4px 10px;margin:0 0 4px;white-space:normal;overflow:visible;text-overflow:clip}/*RG4*/.cb .rg2{opacity:1;color:var(--moss);font-weight:600}/*RG5*/.cb .sbt{font-size:12px;font-weight:600;color:#1F7A4D;margin:-6px 0 8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}/*SUBL*/.cb .sbt{white-space:normal;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;line-height:1.3}/*SUBL2*/.cb .sbt{display:block;-webkit-line-clamp:unset;overflow:visible;white-space:normal;text-overflow:clip}/*SUBL4*/div.srow{display:flex!important;flex-direction:row!important;overflow-x:auto!important;overflow-y:hidden!important;gap:11px;scroll-snap-type:x proximity!important;scroll-padding-left:4px}div.srow>a.c{flex:0 0 78%!important;width:auto!important;scroll-snap-align:start}@media(min-width:620px){div.srow>a.c{flex:0 0 46%!important}}@media(min-width:900px){div.srow>a.c{flex:0 0 30%!important}}/*ARR1*/.swrap{position:relative}.sarr{position:absolute;top:42%;transform:translateY(-50%);left:2px;z-index:5;width:34px;height:34px;border-radius:50%;border:0;background:rgba(255,255,255,.94);box-shadow:0 2px 8px rgba(16,24,40,0.18);font-size:22px;line-height:1;color:#152741;padding:0;cursor:pointer}.sarr.sr{left:auto;right:2px}div.g:has(>a.c){grid-template-columns:1fr!important}a.c{flex-direction:row!important;align-items:stretch}a.c .ph{flex:0 0 118px;width:118px;aspect-ratio:auto!important;height:auto!important;min-height:118px;align-self:stretch}a.c .fav{width:28px;height:28px;top:6px;right:6px}a.c .cb{padding:9px 11px 10px;min-width:0}a.c .t{margin:2px 0 4px}a.c .sbt{margin:0 0 5px}.rgl{display:flex;gap:4px;align-items:flex-start;font-size:12px;line-height:1.35;color:#33425A;margin:0 0 6px}.rgl svg{flex:0 0 auto;margin-top:1px}/*HC1*/a.c .csh{position:absolute;top:6px;left:6px;z-index:3;width:28px;height:28px;border-radius:50%;border:0;padding:0;background:rgba(255,255,255,.94);color:#33425A;display:flex;align-items:center;justify-content:center}a.c .csh svg{width:15px;height:15px}.pcnt{display:inline-flex;align-items:center;gap:3px}.pcnt svg{width:14px;height:14px}/*SHPC*/a.c .cta{width:30px!important;height:30px!important;flex:0 0 30px}a.c .cta svg{width:100%;height:100%}a.c .cta+.cta{margin-left:6px}a.c .m{gap:8px}/*CTA2*/a.c .nphw{background:transparent}a.c .nphw .nphp{object-fit:cover!important;object-position:center!important}/*NPC1*/body{background:#fff!important}.top{background:#fff!important;color:#101828!important;box-shadow:0 1px 0 rgba(16,24,40,.07)}.top a,.top b,.top span,.top div{color:#101828}.top .pin{background:#F2F4F7!important;border:0!important;color:#101828!important}.top .pin b,.top .pin span{color:#101828!important}.lang,.langs,.top nav{background:#F2F4F7!important;border:0!important}.lang a,.langs a,.top nav a{color:#667085!important;background:transparent!important}.lang a.on,.langs a.on,.top nav a.on{background:#101828!important;color:#fff!important}.s{background:#F2F4F7!important;box-shadow:none!important}.s input{color:#101828!important}.c{border:0!important;background:#fff!important;box-shadow:0 2px 10px rgba(16,24,40,.07)!important}/*WSEL2*/html,body{color-scheme:light;} select,option{color-scheme:light !important;}/*WSEL3*//*WSEL1*/select{background:#fff !important;color:#111 !important;border:1px solid #E3E6EA !important;} select option{background:#fff;color:#111;}/*PSHADOW*/.sb2{box-shadow:0 3px 8px rgba(21,39,65,0.18) !important}.sb2.on{box-shadow:0 5px 14px rgba(21,39,65,0.26) !important}.pill{box-shadow:0 3px 8px rgba(21,39,65,0.18) !important}.cat.pic.on .pill{box-shadow:0 5px 14px rgba(21,39,65,0.26) !important}.sb2{background:#fff!important;border:0!important;color:#101828!important;box-shadow:0 1px 6px rgba(16,24,40,.07)}.sb2.on{background:#101828!important;color:#fff!important}.nav{background:#fff!important;border-top:1px solid #EAECF0!important;box-shadow:0 -2px 12px rgba(16,24,40,.06)}.nav a{color:#475467!important}.nav a.on{color:#101828!important}.dcard,.dph{background:#fff!important;border:0!important;box-shadow:0 2px 10px rgba(16,24,40,.07)!important}a.c .rg{border-color:#EAECF0!important}/*WHT1*/.sb2{box-shadow:0 2px 8px rgba(16,24,40,0.10)!important;border:1px solid #E4E7EC!important}.sb2.on{box-shadow:0 3px 10px rgba(16,24,40,0.18)!important;border-color:#101828!important}.c{box-shadow:0 3px 14px rgba(16,24,40,0.08)!important}/*PSH1*/.sb2{box-shadow:0 3px 10px rgba(16,24,40,0.17)!important;border:1px solid #CFD4DC!important}.sb2.on{box-shadow:0 4px 12px rgba(16,24,40,0.26)!important}.c{box-shadow:0 4px 18px rgba(16,24,40,0.13)!important}/*PSH2*/.sb2{border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}.sb2.on{border-color:#101828!important;box-shadow:0 5px 14px rgba(16,24,40,0.33)!important}/*PSH3*/.top .pin{border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}.lang,.langs,.top nav{border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}.s{border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}.rg.on,.reg,.regs a,.rgs a,.rg2s a,.pin.rgp{border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}/*PSH4*/.rg:not(.cb .rg):not(.cb2 .rg){border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important}.rg.on{box-shadow:0 5px 14px rgba(16,24,40,0.33)!important}a.c .rg,.cb .rg{border:1.5px solid #9AA8BF!important;box-shadow:none!important}/*PSH5*//*SHCLIP*/.shchips{padding-top:8px!important;padding-bottom:10px!important}.sb2{box-shadow:0 3px 8px rgba(16,24,40,0.20)!important}.sb2.on{box-shadow:0 3px 0 rgba(16,24,40,0.18),0 6px 16px rgba(16,24,40,0.27)!important}/*SUBOV*/.subbar.shchips{overflow-y:visible!important;padding-top:10px!important;padding-bottom:12px!important}.subbar.shchips .sb2{box-shadow:0 2px 0 rgba(16,24,40,0.12),0 4px 10px rgba(16,24,40,0.20)!important}.subbar.shchips .sb2.on{box-shadow:0 3px 0 rgba(16,24,40,0.18),0 6px 16px rgba(16,24,40,0.27)!important}/*SB2LAST*/.sb2{box-shadow:0 3px 8px rgba(16,24,40,0.20)!important}.sb2.on{box-shadow:0 3px 0 rgba(16,24,40,0.18),0 6px 16px rgba(16,24,40,0.27)!important}.top .lgs{background:#F2F4F7!important;border:1.5px solid #98A2B3!important;box-shadow:0 4px 12px rgba(16,24,40,0.22)!important;border-radius:13px;padding:2px}.top .lg{color:#667085!important;background:transparent!important;padding:5px 11px!important}.top .lg.on{background:#101828!important;color:#fff!important}/*LNG1*/.rpt{margin:10px 0 4px}.rpt summary{list-style:none;cursor:pointer;font-size:13px;color:#8B5A1B;background:#FAEEDA;border-radius:10px;padding:8px 12px;display:inline-block}.rpt summary::-webkit-details-marker{display:none}.rptb{background:#fff;border-radius:12px;padding:10px 12px;margin-top:8px;box-shadow:0 2px 10px rgba(16,24,40,.08)}.rptb p{margin:0 0 8px;font-size:13px;color:#475467}.rptb a{display:block;padding:9px 10px;border-radius:9px;font-size:14px;color:#152741;text-decoration:none;border-bottom:1px solid #EAECF0}.rptb a:last-child{border-bottom:0}.rok{background:#E6F4EC;border-radius:12px;padding:12px 14px;color:#1F5E3C;font-size:15px;margin:12px 0}/*RPT3*/.rptb select,.rptb textarea{width:100%;box-sizing:border-box;border:1px solid #D0D5DD;border-radius:10px;padding:9px 10px;font-size:15px;font-family:inherit;margin-bottom:8px;background:#fff;color:#152741}.rptb button{width:100%;border:0;border-radius:10px;padding:11px;background:#101828;color:#fff;font-size:15px;font-weight:600}/*RPT7*/
...
.cb1.call{background:var(--leaf);box-shadow:0 4px 12px rgba(176,134,43,0.17)}
.cb1.wa{background:#22C15E;box-shadow:0 4px 12px rgba(34,193,94,0.16)}
.cb1.tg{background:#2AA3DA;box-shadow:0 4px 12px rgba(42,163,218,0.16)}
...
.btn{display:flex;align-items:center;justify-content:center;gap:8px;
 ...
 font-size:16px;font-weight:600;box-shadow:0 5px 16px rgba(176,134,43,0.18);
 margin-bottom:14px}
...
.nav a.fab svg{width:50px;height:50px;padding:13px;border-radius:50%;
 ...
 box-shadow:0 6px 18px rgba(58,161,103,0.29),0 0 0 4px #17365C}
