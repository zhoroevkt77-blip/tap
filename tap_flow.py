...
def render(step, data=None):
    ...
    if step == "trade_photo":
        return _view("📸 Сүрөт кошуңуз / Добавьте фото\n\n"
                     "Ылдыйдагы 📎 кыстаргычты басып, галереядан сүрөттөрдү "
                     "тандаңыз (10го чейин).\n"
                     "Сүрөтсүз эле жарыялайм десеңиз — «✅ Даяр» басыңыз.\n\n"
                     "Нажмите 📎 внизу и выберите фото из галереи (до 10).\n"
                     "Без фото — нажмите «✅ Даяр / Готово».",
