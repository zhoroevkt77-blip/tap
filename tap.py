...
def me_page(lang="ky"):
    ...
    about = ("ТАП! — умная платформа объявлений Кыргызстана. Торговля, "
             "продажа имущества, услуги, аренда, доставка, работа, "
             "рынки и такси. Работает в Telegram, WhatsApp и на этом "
             "сайте — база одна."
             if ru else
             "ТАП! — Кыргызстандагы акылдуу жарыя платформасы. "
             "Соода-сатык, мүлк сатуу, кызмат көрсөтүү, ижара, "
             "жеткирүү, жумуш, базарлар жана такси. Telegram'да, "
